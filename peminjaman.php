...
<body>
                                ...
                                foreach($data_inventaris as $data){
                                    ?>
                                        <tr>
                                            <td><?= $data['nama'] ?></td>
                                            <td><?= $data['jumlah'] ?></td>
                                            <td><a href="tambah-peminjaman.php?id=<?= $data['id_inventaris'] ?>">Tambah ke peminjaman</a></td>
                                        </tr>
                                    <?php
                                }
                            ?>
            ...
            <?php
                if(!empty($_SESSION['data_inventaris'])){
                        ...
                        ?>
                            ...
                            <tr>
                                <td></td>
                                <td><a href="hapus-peminjaman.php?id=<?= $id_inventaris ?>">Hapus</a></td>
                            </tr>
                        <?php
                    }
                }
    ...
    <form action="">
        <table align="center">
            <tr>
                <td>Pencarian</td>
                <td><input type="text" name="pencarian_peminjam" readonly placeholder="Masukan nama peminjam.." value="<?= $_SESSION['nama_peminjam'] ?>">
                </td>
            </tr>
            <tr>
